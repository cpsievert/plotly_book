...
include_vimeo("307597427", height = 500)
```
...
include_vimeo("307598025", height = 500)
```
...
```{r shiny-crosstalk-examples, echo=FALSE, fig.cap="Example of a **shiny** app that has **crosstalk** functionality embedded."}
