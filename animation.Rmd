...
```{r profile-pyramid, echo = FALSE, fig.cap = "US population projections by age and gender from 2018 to 2050. This population pyramid is implemented with thick line segments to give the appearance of bars."}
...
```{r profile-lines, echo = FALSE, fig.cap = "Visualizing the same information in Figure \\@ref(fig:profile-pyramid) using lines rather than segments."}
