...
```{r animation-ggplotly, fig.cap = "(ref:animation-ggplotly)", screenshot.alt = "screenshots/animation-ggplotly.png"}
...
```{r animation-opts, fig.cap = "(ref:animation-opts)", screenshot.alt = "screenshots/animation-opts.png"}
base <- gapminder %>%
...
```{r animation-factors, fig.cap = "(ref:animation-factors)", screenshot.alt = "screenshots/animation-factors.png"}
...
```{r animation-targets, fig.cap = "(ref:animation-targets)", screenshot.alt = "screenshots/animation-targets.png"}
base %>%
