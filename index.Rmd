...
out_format <- opts_knit$get("rmarkdown.pandoc.to")
isHTML <- grepl("html", out_format)
isPDF <- grepl("pdf", out_format)
if (isHTML) opts_chunk$set(out.width = "100%")
if (isPDF) opts_chunk$set(out.width = "\\textwidth", fig.width = 8, fig.asp = 0.618)
...
```{r, echo=FALSE, include=isHTML, out.width=220, out.height=245}
...
```{r, echo = FALSE, include=isHTML, results='hide'}
