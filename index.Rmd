...
[This RStudio Cloud instance](https://rstudio.cloud/project/156701) provides a computing environment that you can use to follow along with the book. This book contains many code blocks that produce an interactive graphic, but the interactive graphics themselves are not always included. Sometimes, instead of the interactive, a video is included to demonstrate the interactive capabilities.

```{r, echo=FALSE, fig.link="https://rstudio.cloud/project/156701"}
knitr::include_graphics("https://t1.daumcdn.net/cfile/tistory/99C3553F5BB0414A2A")
```
