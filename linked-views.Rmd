...
* Motivate linked views, perhaps through an example?
* Discuss the pros/cons between client-side/server-side linking
...
```{r txmissing, echo = FALSE, fig.cap = "Graphical query of housing prices in various Texas cities. The query in this particular example must be triggered through clicking directly on a time series."}
...
```{r, eval = FALSE, include = knitr:::is_html_output()}
