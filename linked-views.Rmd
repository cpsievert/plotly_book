...
```{r txmissing-modes, fig.cap = "(ref:txmissing-modes)", screenshot.alt = "images/txmissing-modes.png"}
...
```{r txmissing-linked, fig.cap="(ref:txmissing-linked)", screenshot.alt = "images/txmissing-linked.png"}
...
```{r txhousing-aggregates, fig.cap = "(ref:txhousing-aggregates)", screenshot.alt = "images/txhousing-aggregates.png"}
