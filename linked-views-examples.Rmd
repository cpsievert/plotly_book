...
```{r trellis-txhousing, fig.cap = "(ref:trellis-txhousing)", screenshot.alt = "images/trellis-txhousing.png"}
library(dplyr)
txsmall <- txhousing %>%
...
```{r trellis-txhousing-plotly, fig.cap = "(ref:trellis-txhousing-plotly)", screenshot.alt = "images/trellis-txhousing-plotly.png"}
txsmall %>%
  group_by(city) %>%
  do(
