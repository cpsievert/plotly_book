...
```{r trellis-txhousing, echo = FALSE, fig.cap = "(ref:trellis-txhousing)", code = if (knitr::is_html_output()) readLines("code/trellis-txhousing.R") else knitr::include_graphics("images/trellis-txhousing.png")}
```
...
```{r trellis-txhousing-plotly, echo = FALSE, fig.cap = "(ref:trellis-txhousing-plotly)", code = if (knitr::is_html_output()) readLines("code/trellis-txhousing-plotly.R") else knitr::include_graphics("images/trellis-txhousing-plotly.png")}
```
