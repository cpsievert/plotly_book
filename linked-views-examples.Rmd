...
```{r trellis-txhousing, echo = FALSE, fig.cap = "(ref:trellis-txhousing)"}
if (knitr::is_html_output()) {
  source("code/trellis-txhousing.R")
} else {
...
```{r trellis-txhousing-plotly, echo = FALSE, fig.cap = "(ref:trellis-txhousing-plotly)"}
if (knitr::is_html_output()) {
  source("code/trellis-txhousing-plotly.R")
} else {
