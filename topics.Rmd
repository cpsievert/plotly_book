...
```{r symbols-all, fig.cap = "(ref:symbols-all)", screenshot.alt = "images/symbols-all.png"}
s <- schema()
...
```{r glyphs, fig.cap = "(ref:glyphs)", screenshot.alt = "images/glyphs.png"}
plot_ly() %>% 
  add_text(
    x = rep(2, 2), 
    y = 1:2, 
...
```{r emojis, fig.cap = "(ref:emojis)", screenshot.alt = "images/emojis.png"}
library(emo)
set.seed(100)
jis %>%
...
```{r simple-scatterplot, fig.cap="(ref:simple-scatterplot)"}
