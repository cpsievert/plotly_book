...
```{r custom-tooltip-plotly, echo = FALSE, fig.cap = "(ref:custom-tooltip-plotly)"}
...
```{r hoveron-fill-points, echo = FALSE, fig.cap = "(ref:hoveron-fill-points)"}
...
```{r tooltip-format-boxplot, echo = FALSE, fig.cap = "(ref:tooltip-format-boxplot)"}
...
```{r tooltip-format-heatmap, echo = FALSE, fig.cap = "(ref:tooltip-format-heatmap)"}
...
```{r hovertemplate, echo = FALSE, fig.cap = "(ref:hovertemplate)"}
...
```{r ggplotly-text, echo = FALSE, fig.cap = "(ref:ggplotly-text)"}
...
```{r ggplotly-text-tooltip, echo = FALSE, fig.cap = "(ref:ggplotly-text-tooltip)"}
...
```{r format-options, echo = FALSE, fig.cap="(ref:format-options)"}
...
```{r text-clever, echo = FALSE, fig.cap="(ref:text-clever)"}
...
```{r custom-predict-text, echo = FALSE, fig.cap="(ref:custom-predict-text)"}
...
```{r tooltip-style, echo = FALSE, fig.cap="(ref:tooltip-style)"}
...
```{r tooltip-style-ggplotly, echo = FALSE, fig.cap="(ref:tooltip-style-ggplotly)"}
...
```{r color-plotly-js, echo = FALSE, fig.cap="(ref:color-plotly-js)"}
...
```{r symbols-all, echo = FALSE, fig.cap = "(ref:symbols-all)", code = if (knitr::is_html_output()) readLines("code/symbols-all.R") else knitr::include_graphics("images/symbols-all.png")}
```
...
```{r glyphs, echo = FALSE, fig.cap = "(ref:glyphs)"}
...
```{r localization, echo = FALSE, fig.cap="(ref:localization)"}
...
```{r mathjax, echo = FALSE, fig.cap="(ref:mathjax)"}
...
```{r mathjax2, echo = FALSE, fig.cap="(ref:mathjax2)"}
...
```{r houston2, echo = FALSE, fig.cap = "(ref:houston2)"}
...
```{r houston-vs-sa, echo = FALSE, fig.cap = "(ref:houston-vs-sa)"}
...
```{r summary, echo = FALSE, fig.cap = "(ref:summary)"}
...
```{r forecast, echo = FALSE, fig.cap = "(ref:forecast)"}
...
# Improving `ggplotly()` {#modifying-ggplotly}
...
```{r simple-scatterplot, echo=FALSE, fig.cap="(ref:simple-scatterplot)"}
...
```{r listviewer, echo = FALSE, fig.cap = "(ref:listviewer)"}
...
```{r style-hoverinfo, echo = FALSE, fig.cap = "(ref:style-hoverinfo)"}
...
```{r se-annotations, echo = FALSE, fig.cap = "(ref:se-annotations)"}
...
```{r StatBin, echo = FALSE, fig.cap = "(ref:StatBin)"}
...
```{r StatDensity2d, echo = FALSE, fig.cap = "(ref:StatDensity2d)"}
...
```{r image-hyperlink, echo = FALSE, fig.cap="(ref:image-hyperlink)"}
...
```{r image-uri, echo = FALSE, fig.cap="(ref:image-uri)"}
...
```{r raster, echo = FALSE, fig.cap = "(ref:raster)"}
