...
```{r split-color, echo = FALSE, fig.cap = "Using `split` and `color` to create a choropleth map of provinces in Canada."}
...
```{r split-text, echo = FALSE, fig.cap = "Using `split`, `text`, and `hoveron='fills'` to display a tooltip specific to each Canadian province."}
knitr::include_graphics("images/split-text.svg")
```
