...
```{r trelliscope, echo = FALSE, fig.cap = "Using **trelliscopejs** to surface high-dimensional insights related to life expectancy and GDP per capita in various countries."}
