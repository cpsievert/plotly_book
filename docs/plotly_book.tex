...
\CommentTok{#>  [7] "satellite-streets" "open-street-map"  }
\CommentTok{#>  [9] "white-bg"          "carto-positron"   }
\CommentTok{#> [11] "carto-darkmatter"  "stamen-terrain"   }
\CommentTok{#> [13] "stamen-toner"      "stamen-watercolor"}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{plotly_data}\NormalTok{()}
\CommentTok{#> # A tibble: 80 x 14}
\CommentTok{#>       x     y  ymin  ymax    se flipped_aes PANEL group}
\CommentTok{#>   <dbl> <dbl> <dbl> <dbl> <dbl> <lgl>       <fct> <int>}
\CommentTok{#> 1  1.51  32.1  28.1  36.0  1.92 FALSE       1        -1}
\CommentTok{#> 2  1.56  31.7  28.2  35.2  1.72 FALSE       1        -1}
\CommentTok{#> 3  1.61  31.3  28.1  34.5  1.54 FALSE       1        -1}
\CommentTok{#> 4  1.66  30.9  28.0  33.7  1.39 FALSE       1        -1}
\CommentTok{#> 5  1.71  30.5  27.9  33.0  1.26 FALSE       1        -1}
\CommentTok{#> 6  1.76  30.0  27.7  32.4  1.16 FALSE       1        -1}
\CommentTok{#> # ... with 74 more rows, and 6 more variables:}
\CommentTok{#> #   colour <chr>, fill <chr>, size <dbl>,}
\CommentTok{#> #   linetype <dbl>, weight <dbl>, alpha <dbl>}
\end{Highlighting}
\end{Shaded}
