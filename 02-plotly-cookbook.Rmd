...
This chapter demonstrates the capabilities of `plot_ly()` through a series of examples. In a nutshell, `plot_ly()` aims to: 
...
Given a numeric variable(s) on x and y, `plot_ly()` defaults to a scatterplot

```{r}
subplot(
  plot_ly(mtcars, x = ~wt, y = ~mpg),
  plot_ly(mtcars, x = ~wt, y = ~mpg, color = ~disp),
