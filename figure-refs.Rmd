...
(ref:shiny-drill-down-pie) `r if (!knitr::is_html_output()) "For a video demonstration of the interactive, see <https://vimeo.com/328763167>"`

(ref:shiny-drill-down-pie-time) `r if (!knitr::is_html_output()) "For a video demonstration of the interactive, see <https://vimeo.com/328768848>"`

(ref:shiny-drill-down-pie-time-history) `r if (!knitr::is_html_output()) "For a video demonstration of the interactive, see <https://vimeo.com/328770954>"`
