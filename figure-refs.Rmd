...
(ref:geo-flights) Using the integrated orthographic projection to visualize flight patterns on a '3D' globe. `r if (!knitr::is_html_output()) "For a video demonstration of the interactive, see <https://vimeo.com/317358033>"`
